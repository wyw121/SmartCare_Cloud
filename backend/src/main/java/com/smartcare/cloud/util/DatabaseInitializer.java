 ...
 */
@Component
public class HealthWarningDataInitializer implements ApplicationRunner {

    private static final Logger logger = LoggerFactory.getLogger(HealthWarningDataInitializer.class);
    ...
    private String getLevelName(Integer level) {
        switch (level) {
            case 1: return "级别1(低风险)";
            case 2: return "级别2(中风险)";
            case 3: return "级别3(高风险)";
            case 4: return "级别4(紧急)";
            default: return "未知级别";
        }
    }
    ...
    private String getStatusName(Integer status) {
        switch (status) {
            case 0: return "状态0(未处理)";
            case 1: return "状态1(已查看)";
            case 2: return "状态2(处理中)";
            case 3: return "状态3(已处理)";
            case 4: return "状态4(已忽略)";
            default: return "未知状态";
        }
    }
}