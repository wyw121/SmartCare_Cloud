...
| **数据层** | MyBatis-Plus | 3.5.3.1 | 增强型ORM框架 |
| **数据库** | MySQL | 8.0.33 | 关系型数据库 |
| **缓存** | Redis | 6.x+ | 内存数据库 |
| **前端** | Vue | 3.4.0 | 渐进式JavaScript框架 |
| **UI框架** | Element Plus | 2.4.4 | Vue3组件库 |
| **构建工具** | Vite | 5.0.10 | 现代化构建工具 |
| **状态管理** | Pinia | 2.1.7 | Vue3状态管理 |
...
| **frontend/** | 前端Vue 3应用 | `main.js`、`package.json`、`vite.config.js` |
...
| 服务 | 地址 | 说明 |
|------|------|------|
| **前端应用** | http://localhost:3000 | Vue 3前端界面 |
