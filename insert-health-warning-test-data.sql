...
VALUES -- 1. 张国强 - 血压异常 - 高风险未处理
  (
    ...
    3,
    '张国强血压监测异常',
    '根据血压监测设备监测数据，发现张国强的血压异常情况，需要及时关注和处理。',
    '收缩压: 165mmHg, 舒张压: 98mmHg',
    '血压监测设备',
    0,
    NULL,
    NULL,
  ...
  (
    ...
    2,
    '李秀英血糖水平异常',
    '根据血糖仪监测数据，发现李秀英的血糖异常情况，需要及时关注和处理。',
    '血糖值: 8.2mmol/L',
    '血糖仪',
    1,
    NULL,
  ...
  (
    ...
    4,
    '王建国心率不规律',
    '根据心率监测器监测数据，发现王建国的心率异常情况，需要及时关注和处理。',
    '心率: 120次/分',
    '心率监测器',
    3,
    1,
    '张医生',
    '2024-06-27 10:30:00',
    '已联系家属，王建国的心率异常情况已得到及时处理，目前状况稳定。',
    1,
    1,
    '2024-06-27 10:00:00'
  ),
  ...
  (
    ...
    2,
    '赵淑芳体温异常',
    '根据体温计监测数据，发现赵淑芳的体温异常情况，需要及时关注和处理。',
    '体温: 38.2°C',
    '体温计',
    2,
    1,
  ...
  (
    ...
    1,
    '刘德华长时间无活动迹象',
    '根据活动监测器监测数据，发现刘德华的长期不活动情况，需要及时关注和处理。',
    '连续10小时无活动记录',
    '活动监测器',
    4,
    1,
  ...
  (
    ...
    2,
    '陈美丽未按时服药提醒',
    '根据药物提醒器监测数据，发现陈美丽的药物未按时服用情况，需要及时关注和处理。',
    '降压药延迟2小时服用',
    '药物提醒器',
    0,
    NULL,
  ...
  (
    ...
    3,
    '孙文华跌倒风险预警',
    '根据跌倒检测器监测数据，发现孙文华的跌倒风险情况，需要及时关注和处理。',
    '行走不稳，步态异常评分: 85',
    '跌倒检测器',
    1,
    NULL,
  ...
  (
    ...
    4,
    '周桂花血压监测异常',
    '根据血压监测设备监测数据，发现周桂花的血压异常情况，需要及时关注和处理。',
  ...
  (
    ...
    3,
    '吴国庆心率不规律',
    '根据心率监测器监测数据，发现吴国庆的心率异常情况，需要及时关注和处理。',
    '心率: 45次/分',
    '心率监测器',
    2,
    1,
  ...
  (
    ...
    4,
    '郑丽华血糖水平异常',
    '根据血糖仪监测数据，发现郑丽华的血糖异常情况，需要及时关注和处理。',
    '血糖值: 12.5mmol/L',
    '血糖仪',
    3,
    1,
  ...
  (
    ...
    1,
    '马志强体温异常',
    '根据体温计监测数据，发现马志强的体温异常情况，需要及时关注和处理。',
    '体温: 37.2°C',
    '体温计',
    1,
    NULL,
  ...
  (
    ...
    2,
    '黄春梅长时间无活动迹象',
    '根据活动监测器监测数据，发现黄春梅的长期不活动情况，需要及时关注和处理。',
    '连续8小时无活动记录',
    '活动监测器',
    0,
    NULL,
  ...
  (
    ...
    3,
    '林国栋未按时服药提醒',
    '根据药物提醒器监测数据，发现林国栋的药物未按时服用情况，需要及时关注和处理。',
    '心脏药延迟3小时服用',
    '药物提醒器',
    3,
    1,
  ...
  (
    ...
    1,
    '杨秀珍跌倒风险预警',
    '根据跌倒检测器监测数据，发现杨秀珍的跌倒风险情况，需要及时关注和处理。',
    '步态异常评分: 75',
    '跌倒检测器',
    4,
    1,
  ...
  (
    ...
    2,
    '何建军健康状况异常',
    '根据手动录入监测数据，发现何建军的其他异常情况，需要及时关注和处理。',
    '综合健康评分异常: 65',
    '手动录入',
    2,
    1,
  ...
  (
    ...
    1,
    '张国强心率监测异常',
    '根据心率监测器监测数据，发现张国强的心率异常情况，需要及时关注和处理。',
    '心率: 95次/分',
    '心率监测器',
    0,
    NULL,
  ...
  (
    ...
    4,
    '李秀英体温异常',
    '根据体温计监测数据，发现李秀英的体温异常情况，需要及时关注和处理。',
    '体温: 39.5°C',
    '体温计',
    1,
    NULL,
  ...
  (
    ...
    2,
    '王建国血压监测异常',
    '根据血压监测设备监测数据，发现王建国的血压异常情况，需要及时关注和处理。',
    '收缩压: 150mmHg, 舒张压: 95mmHg',
    '血压监测设备',
    0,
    NULL,
    NULL,
  ...
  (
    ...
    1,
    '赵淑芳未按时服药提醒',
    '根据药物提醒器监测数据，发现赵淑芳的药物未按时服用情况，需要及时关注和处理。',
    '降糖药延迟1小时服用',
    '药物提醒器',
    3,
    1,
  ...
  (
    ...
    3,
    '刘德华血糖水平异常',
    '根据血糖仪监测数据，发现刘德华的血糖异常情况，需要及时关注和处理。',
    '血糖值: 10.8mmol/L',
    '血糖仪',
    2,
    1,
